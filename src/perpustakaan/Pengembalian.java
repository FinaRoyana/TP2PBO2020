...
public class Pengembalian extends javax.swing.JFrame {
    ...
    public Pengembalian() {
        ...
        private void TampilData(){
         String[] kolom = {"KODE BUKU", "JUDUL BUKU", "NAMA PEMINJAM", "TANGGAL PINJAM", "TANGGAL KEMBALI"};
    ...
    private void Hapus(){
        ...
        try {
            Statement stmt = koneksi.createStatement();
            String query = "DELETE FROM tabel_peminjaman WHERE KodeBuku = '"+kode+"'; ";
    ...
    private void initComponents() {
        ...
        //jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/icons8-return-52.png"))); // NOI18N
